            ...
            <p class="mb-0 text-stream-gray text-base mt-[10px] text-center">Rating: <?=$results->vote_average?></p>
                 ...
                 ?>
                                       ...
                                       <div class="col-4 mb-4 d-flex text-center px-3">
                                           ...
                                           <div class="card" style="width: 18rem;">
                                           <a href="tvshow-oca.php?id=<?=$tt->id ?>"> <img
                                                   src="<?=$imgurl_2?><?=$tt->poster_path?>" style="border-radius:10px;" alt="" width=250px></a>
                                           <h6 class="text-center mt-2"><?=$tt->original_name?></h6>
                                           <p class="mb-0 text-stream-gray text-base mt-[10px] text-center">First Air: <?=$tt->first_air_date?></p>
